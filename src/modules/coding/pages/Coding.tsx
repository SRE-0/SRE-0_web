...
const screenshots = [
  { image: 'src/assets/images/projects/teampyros/app/home.webp', description: 'Home screen' },
  { image: 'src/assets/images/projects/teampyros/app/history.webp', description: 'Home screen' },
  { image: 'src/assets/images/projects/teampyros/app/home_dark.webp', description: 'Home screen' },
  { image: 'src/assets/images/projects/teampyros/app/history_dark.webp', description: 'Home screen' },
]

const images = [
  { image: 'src/assets/images/projects/teampyros/images/team.jpg', description: 'Home screen' },
  { image: 'src/assets/images/projects/teampyros/images/team0.jpg', description: 'Home screen' },
  { image: 'src/assets/images/projects/teampyros/images/team1.jpg', description: 'Home screen' },
  { image: 'src/assets/images/projects/teampyros/images/team2.jpg', description: 'Home screen' },
]
...
export default function Coding() {
  return (
    <div>
      ...
      <HeaderImage
        image="src/assets/images/projects/teampyros/teampyros_80.webp"
        description=''
      />
      ...
      <SingleImage
        image='src/assets/images/projects/teampyros/images/team.jpg'
        description=''
      />
      ...
      <h2>Ganadores</h2>
      <SingleImage
        image='src/assets/images/projects/teampyros/images/team4.jpg'
        description=''
      />
